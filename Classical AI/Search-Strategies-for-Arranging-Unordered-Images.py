...
class ImageAgent(Agent):
    ...
    def __init__(self, unique_id, model):
        ...
        self.top = np.random.rand(100)
        self.bottom = np.random.rand(100) 
        self.left = np.random.rand(100)
        self.right = np.random.rand(100)
        
        #estimates of values beyond the image border
        #generate 100 random pixel values for each side
        self.topForecast = np.random.rand(100)
        self.bottomForecast = np.random.rand(100) 
        self.leftForecast = np.random.rand(100)
        self.rightForecast = np.random.rand(100)
